...
### 2. تفعيل علامة الكشف عن اللغات المتعددة

1. افتح **`chrome://flags/#language-detection-api-for-gemini-nano`**
2. اضبط العلامة على **"Enabled"**
3. انقر **"Relaunch"** لإعادة تشغيل Chrome

### 3. التحقق من حالة النموذج
...
2. يجلب النص المكتوب من YouTube
