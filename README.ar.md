<div align="center" dir="rtl">
  ...
  <p>اختر بين ثلاثة محركات ذكاء اصطناعي: <strong>Gemini API</strong> (سحابي، خطة مجانية) أو <strong>Gemini Nano</strong> (مدمج في Chrome) أو <strong>Ollama</strong> (خادم محلي). يعمل <strong>لأي لغة</strong>.</p>
</div>
...
- 🤖 **ثلاثة محركات ذكاء اصطناعي** — استخدم Gemini API (سحابي) أو Gemini Nano (ذكاء اصطناعي مدمج في Chrome) أو Ollama (نماذج محلية)
...
- **Gemini API**: مفتاح API مجاني من [Google AI Studio](https://aistudio.google.com/apikey)
...
يستخدم Gemini API نماذج الذكاء الاصطناعي السحابية من Google بمفتاح API مجاني من Google AI Studio. يعمل على أي متصفح قائم على Chromium ولا يتطلب تنزيل أي نموذج.

> على عكس Gemini Nano وOllama، يرسل Gemini API النص إلى خوادم Google لمعالجته.

### 1. احصل على مفتاح API الخاص بك

1. اذهب إلى **Google AI Studio**: [aistudio.google.com/apikey](https://aistudio.google.com/apikey)
2. سجّل الدخول بحساب Google الخاص بك
3. انقر على **"Create API key"**
4. انسخ المفتاح الذي تم إنشاؤه (يبدأ بـ `AIza...`)

> يوفر Gemini API خطة مجانية بحدود استخدام سخية — لا حاجة إلى بطاقة ائتمان للبدء.

### 2. الإعداد داخل الإضافة

1. انقر على أيقونة الإضافة
2. اختر علامة تبويب **API Gemini**
3. ألصق مفتاح API في الحقل
4. انقر على **موافق** لحفظ المفتاح واختباره
...
3. يرسل النص إلى محرك الذكاء الاصطناعي المختار (Gemini API أو Gemini Nano أو Ollama) لتصنيف مستوى CEFR
...
<div align="center">
  <sub>يعمل Gemini Nano وOllama محليًا بنسبة 100% — دون الحاجة إلى مفتاح API. أما Gemini API فاختياري ويستخدم مفتاحًا مجانيًا من Google AI Studio.</sub>
</div>
