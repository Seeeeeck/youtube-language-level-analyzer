<div align="center">
  ...
  <p>तीन AI इंजनों में से चुनें: <strong>Gemini API</strong> (क्लाउड, मुफ़्त स्तर), <strong>Gemini Nano</strong> (Chrome में निर्मित), या <strong>Ollama</strong> (स्थानीय सर्वर)। <strong>किसी भी भाषा</strong> के लिए काम करता है।</p>
</div>
...
- 🤖 **तीन AI इंजन** — Gemini API (क्लाउड), Gemini Nano (अंतर्निहित Chrome AI), या Ollama (स्थानीय मॉडल) का उपयोग करें
...
- **Gemini API**: [Google AI Studio](https://aistudio.google.com/apikey) से मुफ़्त API कुंजी
...
Gemini API, Google AI Studio से मिलने वाली मुफ़्त API कुंजी के साथ Google के क्लाउड AI मॉडल का उपयोग करता है। यह किसी भी Chromium-आधारित ब्राउज़र पर काम करता है और किसी भी मॉडल को डाउनलोड करने की आवश्यकता नहीं होती।

> Gemini Nano और Ollama के विपरीत, Gemini API प्रोसेसिंग के लिए ट्रांसक्रिप्ट को Google के सर्वर पर भेजता है।

### 1. अपनी API कुंजी प्राप्त करें

1. **Google AI Studio** पर जाएं: [aistudio.google.com/apikey](https://aistudio.google.com/apikey)
2. अपने Google खाते से साइन इन करें
3. **"Create API key"** पर क्लिक करें
4. जनरेट की गई कुंजी कॉपी करें (`AIza...` से शुरू होती है)

> Gemini API में एक मुफ़्त स्तर है जिसमें उदार उपयोग सीमाएं हैं — शुरुआत करने के लिए क्रेडिट कार्ड की आवश्यकता नहीं है।

### 2. एक्सटेंशन में कॉन्फ़िगर करें

1. एक्सटेंशन आइकन पर क्लिक करें
2. **API Gemini** टैब चुनें
3. अपनी API कुंजी फ़ील्ड में पेस्ट करें
4. कुंजी सहेजने और परीक्षण करने के लिए **OK** पर क्लिक करें
...
3. CEFR वर्गीकरण के लिए चयनित AI इंजन (Gemini API, Gemini Nano, या Ollama) को ट्रांसक्रिप्ट भेजता है
...
<div align="center">
  <sub>Gemini Nano और Ollama पूरी तरह स्थानीय रूप से चलते हैं — किसी API कुंजी की आवश्यकता नहीं है। Gemini API वैकल्पिक है और Google AI Studio की मुफ़्त कुंजी का उपयोग करता है।</sub>
</div>
