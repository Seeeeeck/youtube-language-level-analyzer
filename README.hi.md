...
<p align="center">
  <img src="yl.png" alt="YouTube वीडियो पर CEFR बैज" width="700">
  <br>
...
### 2. बहु-भाषा पहचान फ़्लैग सक्षम करें

1. **`chrome://flags/#language-detection-api-for-gemini-nano`** खोलें
2. फ़्लैग को **"Enabled"** पर सेट करें
3. Chrome को पुनरारंभ करने के लिए **"Relaunch"** पर क्लिक करें

### 3. मॉडल स्थिति जाँचें
...
2. YouTube से ट्रांसक्रिप्ट प्राप्त करता है
