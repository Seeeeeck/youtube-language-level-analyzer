...
### 2. Включите флаг многоязычного распознавания

1. Откройте **`chrome://flags/#language-detection-api-for-gemini-nano`**
2. Установите флаг в положение **«Enabled»**
3. Нажмите **«Relaunch»** для перезапуска Chrome

### 3. Проверьте статус модели
...
2. Получает транскрипцию с YouTube
