...
const LANG = {
  ...
  pt: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Servidor', ok: 'OK', model: 'Modelo', lang: 'Idioma', nanoInstructions: 'Instruções', ollamaInstructions: 'Instruções', noModels: '⚠ Sem modelos', noConn: '✗ Servidor sem conexão', ready: v => `✓ ${v} pronto`, nanoUnavail: 'Indisponível', nanoReady: 'Disponível', nanoDownloading: 'Baixando...', nanoDownloadable: 'Baixável', analLang: 'Idioma de análise', networkTip: 'Para servidores remotos, ative "Expor Ollama à rede" nas Configurações do Ollama.', supportsExt: 'Apoie a extensão 🙂' },
  ...
  it: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Server', ok: 'OK', model: 'Modello', lang: 'Lingua', nanoInstructions: 'Istruzioni', ollamaInstructions: 'Istruzioni', noModels: '⚠ Nessun modello', noConn: '✗ Server non raggiungibile', ready: v => `✓ ${v} pronto`, nanoUnavail: 'Non disponibile', nanoReady: 'Disponibile', nanoDownloading: 'Download...', nanoDownloadable: 'Scaricabile', analLang: 'Lingua di analisi', networkTip: 'Per server remoti, abilita "Esponi Ollama alla rete" nelle Impostazioni di Ollama.', supportsExt: 'Supporta l\'estensione 🙂' },
  zh: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: '服务器', ok: '确定', model: '模型', lang: '语言', nanoInstructions: '说明', ollamaInstructions: '说明', noModels: '⚠ 无可用模型', noConn: '✗ 服务器无法连接', ready: v => `✓ ${v} 就绪`, nanoUnavail: '不可用', nanoReady: '可用', nanoDownloading: '下载中...', nanoDownloadable: '可下载', analLang: '分析语言', networkTip: '对于远程服务器，请在Ollama设置中启用"将Ollama暴露到网络"。', supportsExt: '支持扩展 🙂' },
  ja: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'サーバー', ok: 'OK', model: 'モデル', lang: '言語', nanoInstructions: '説明書', ollamaInstructions: '説明書', noModels: '⚠ モデルがありません', noConn: '✗ サーバーに接続できません', ready: v => `✓ ${v} 準備完了`, nanoUnavail: '利用不可', nanoReady: '利用可能', nanoDownloading: 'ダウンロード中...', nanoDownloadable: 'ダウンロード可能', analLang: '分析言語', networkTip: 'リモートサーバーの場合は、Ollama設定で「Ollamaをネットワークに公開する」を有効にしてください。', supportsExt: '拡張機能をサポート 🙂' },
  ...
  ar: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'الخادم', ok: 'موافق', model: 'النموذج', lang: 'اللغة', nanoInstructions: 'تعليمات', ollamaInstructions: 'تعليمات', noModels: '⚠ لا توجد نماذج', noConn: '✗ الخادم غير متاح', ready: v => `✓ ${v} جاهز`, nanoUnavail: 'غير متاح', nanoReady: 'متاح', nanoDownloading: 'جارٍ التحميل...', nanoDownloadable: 'قابل للتحميل', analLang: 'لغة التحليل', networkTip: 'للخوادم البعيدة، قم بتمكين "كشف Ollama للشبكة" في إعدادات Ollama.', supportsExt: 'ادعم الإضافة 🙂' },
