...
const LANG = {
  ...
  ar: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'الخادم', ok: 'موافق', model: 'النموذج', lang: 'اللغة', nanoInstructions: 'تعليمات', ollamaInstructions: 'تعليمات', noModels: '⚠ لا توجد نماذج', noConn: '✗ الخادم غير متاح', loading: 'جارٍ تحميل Ollama...', ready: v => `✓ ${v} جاهز`, nanoUnavail: 'غير متاح', nanoReady: 'متاح', nanoDownloading: pct => `جارٍ التحميل${pct != null ? ` ${pct}%` : '...'} لا تغلق المتصفح`, nanoDownloadable: 'قابل للتحميل', analLang: 'لغة التحليل', networkTip: 'للخوادم البعيدة، قم بتمكين "كشف Ollama للشبكة" في إعدادات Ollama.', supportsExt: 'ادعم الإضافة 🙂', nanoFlagBtn: 'تفعيل Prompt API for Gemini Nano Multilingual وإعادة تشغيل المتصفح', chromeRecommend: 'يوصى باستخدام متصفح Google Chrome', corsError: '✗ خطأ CORS: الخادم يرفض الإضافة', corsInstructions: 'عرض التعليمات', sampleSize: 'عدد الأحرف المراد تحليلها', sampleFast: '3000 حرف (سريع)', sampleBalanced: '6000 حرف (متوازن)', samplePrecise: '12000 حرف (أكثر دقة)' },
