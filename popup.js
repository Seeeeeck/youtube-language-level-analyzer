...
const LANG = {
  es: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Servidor', ok: 'OK', model: 'Modelo', lang: 'Lenguaje de la extensión', nanoInstructions: 'Instrucciones', ollamaInstructions: 'Instrucciones', noModels: '⚠ Sin modelos disponibles', noConn: '✗ Servidor sin conexión', ready: v => `✓ ${v} listo`, nanoUnavail: 'No disponible', nanoReady: 'Disponible', nanoDownloading: 'Descargando...', nanoDownloadable: 'Descargable', analLang: 'Idioma de análisis', supportsExt: 'Apoya la extensión 🙂' },
  en: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Server', ok: 'OK', model: 'Model', lang: 'Language', nanoInstructions: 'Instructions', ollamaInstructions: 'Instructions', noModels: '⚠ No models available', noConn: '✗ Server unreachable', ready: v => `✓ ${v} ready`, nanoUnavail: 'Unavailable', nanoReady: 'Available', nanoDownloading: 'Downloading...', nanoDownloadable: 'Downloadable', analLang: 'Analysis language', supportsExt: 'Supports the extension 🙂' },
  fr: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Serveur', ok: 'OK', model: 'Modèle', lang: 'Langue', nanoInstructions: 'Instructions', ollamaInstructions: 'Instructions', noModels: '⚠ Aucun modèle', noConn: '✗ Serveur inaccessible', ready: v => `✓ ${v} prêt`, nanoUnavail: 'Indisponible', nanoReady: 'Disponible', nanoDownloading: 'Téléchargement...', nanoDownloadable: 'Téléchargeable', analLang: 'Langue d\'analyse', supportsExt: 'Soutenez l\'extension 🙂' },
  pt: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Servidor', ok: 'OK', model: 'Modelo', lang: 'Idioma', nanoInstructions: 'Instruções', ollamaInstructions: 'Instruções', noModels: '⚠ Sem modelos', noConn: '✗ Servidor sem conexão', ready: v => `✓ ${v} pronto`, nanoUnavail: 'Indisponível', nanoReady: 'Disponível', nanoDownloading: 'Baixando...', nanoDownloadable: 'Baixável', analLang: 'Idioma de análise', supportsExt: 'Apoie a extensão 🙂' },
  de: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Server', ok: 'OK', model: 'Modell', lang: 'Sprache', nanoInstructions: 'Anleitung', ollamaInstructions: 'Anleitung', noModels: '⚠ Keine Modelle', noConn: '✗ Server nicht erreichbar', ready: v => `✓ ${v} bereit`, nanoUnavail: 'Nicht verfügbar', nanoReady: 'Verfügbar', nanoDownloading: 'Wird heruntergeladen...', nanoDownloadable: 'Herunterladbar', analLang: 'Analysesprache', supportsExt: 'Unterstütze die Erweiterung 🙂' },
  it: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Server', ok: 'OK', model: 'Modello', lang: 'Lingua', nanoInstructions: 'Istruzioni', ollamaInstructions: 'Istruzioni', noModels: '⚠ Nessun modello', noConn: '✗ Server non raggiungibile', ready: v => `✓ ${v} pronto`, nanoUnavail: 'Non disponibile', nanoReady: 'Disponibile', nanoDownloading: 'Download...', nanoDownloadable: 'Scaricabile', analLang: 'Lingua di analisi', supportsExt: 'Supporta l\'estensione 🙂' },
  zh: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: '服务器', ok: '确定', model: '模型', lang: '语言', nanoInstructions: '说明', ollamaInstructions: '说明', noModels: '⚠ 无可用模型', noConn: '✗ 服务器无法连接', ready: v => `✓ ${v} 就绪`, nanoUnavail: '不可用', nanoReady: '可用', nanoDownloading: '下载中...', nanoDownloadable: '可下载', analLang: '分析语言', supportsExt: '支持扩展 🙂' },
  ja: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'サーバー', ok: 'OK', model: 'モデル', lang: '言語', nanoInstructions: '説明書', ollamaInstructions: '説明書', noModels: '⚠ モデルがありません', noConn: '✗ サーバーに接続できません', ready: v => `✓ ${v} 準備完了`, nanoUnavail: '利用不可', nanoReady: '利用可能', nanoDownloading: 'ダウンロード中...', nanoDownloadable: 'ダウンロード可能', analLang: '分析言語', supportsExt: '拡張機能をサポート 🙂' },
  ko: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: '서버', ok: '확인', model: '모델', lang: '언어', nanoInstructions: '설명서', ollamaInstructions: '설명서', noModels: '⚠ 모델 없음', noConn: '✗ 서버 연결 불가', ready: v => `✓ ${v} 준비 완료`, nanoUnavail: '사용 불가', nanoReady: '사용 가능', nanoDownloading: '다운로드 중...', nanoDownloadable: '다운로드 가능', analLang: '분석 언어', supportsExt: '확장 지원하기 🙂' },
  ar: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'الخادم', ok: 'موافق', model: 'النموذج', lang: 'اللغة', nanoInstructions: 'تعليمات', ollamaInstructions: 'تعليمات', noModels: '⚠ لا توجد نماذج', noConn: '✗ الخادم غير متاح', ready: v => `✓ ${v} جاهز`, nanoUnavail: 'غير متاح', nanoReady: 'متاح', nanoDownloading: 'جارٍ التحميل...', nanoDownloadable: 'قابل للتحميل', analLang: 'لغة التحليل', supportsExt: 'ادعم الإضافة 🙂' },
  hi: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'सर्वर', ok: 'ठीक', model: 'मॉडल', lang: 'भाषा', nanoInstructions: 'निर्देश', ollamaInstructions: 'निर्देश', noModels: '⚠ कोई मॉडल नहीं', noConn: '✗ सर्वर से कनेक्ट नहीं हो सका', ready: v => `✓ ${v} तैयार`, nanoUnavail: 'अनुपलब्ध', nanoReady: 'उपलब्ध', nanoDownloading: 'डाउनलोड हो रहा है...', nanoDownloadable: 'डाउनलोड योग्य', analLang: 'विश्लेषण भाषा', supportsExt: 'एक्सटेंशन का समर्थन करें 🙂' },
  ru: { title: 'YT Level Language Analyzer', nano: 'Gemini Nano', ollama: 'Ollama', server: 'Сервер', ok: 'ОК', model: 'Модель', lang: 'Язык', nanoInstructions: 'Инструкция', ollamaInstructions: 'Инструкция', noModels: '⚠ Нет моделей', noConn: '✗ Сервер недоступен', ready: v => `✓ ${v} готов`, nanoUnavail: 'Недоступно', nanoReady: 'Доступно', nanoDownloading: 'Загрузка...', nanoDownloadable: 'Загружаемый', analLang: 'Язык анализа', supportsExt: 'Поддержите расширение 🙂' },
}
